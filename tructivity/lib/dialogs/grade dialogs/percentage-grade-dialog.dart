...
class PercentageGradeDialog extends StatelessWidget {
  final PercentageGradeModel gradeData;
  final _formKey = GlobalKey<FormState>();
  final String table = 'percentageGrade';
  final String category;
  PercentageGradeDialog({required this.gradeData, required this.category});
  final DatabaseHelper _db = DatabaseHelper.instance;
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      scrollable: true,
      title: Text('Percentage Based Grade'),
